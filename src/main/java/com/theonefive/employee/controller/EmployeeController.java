...
public class EmployeeController {
    ...
    public String updateInfo(EmployeeDTO dto, RedirectAttributes redirectAttributes) {
    ...
    public String updatePassword(EmployeeDTO dto, RedirectAttributes redirectAttributes) {
