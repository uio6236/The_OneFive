...
<div class="customer-page">
    ...
    <!-- 고객 Header -->
    <jsp:include
        page="/WEB-INF/views/common/customerHeader.jsp"
    />
            ...
            <div class="customer-room-grid">
                ...
                <article class="customer-room-card">
                    ...
                    <div class="room-card-content">
                        ...
                        <div class="room-card-bottom">
                            ...
                            <a
                                href="/customer/reservation/detail?roomType=DELUXE_DOUBLE"
                ...
                <article class="customer-room-card">
                    ...
                    <div class="room-card-content">
                        ...
                        <div class="room-card-bottom">
                            ...
                            <a
                                href="/customer/reservation/detail?roomType=DELUXE_TWIN"
                                class="btn btn-primary"
                            >
                                상세보기 및 예약
                            </a>
                ...
                <article class="customer-room-card">
                    ...
                    <div class="room-image-wrapper">
                        ...
                        <img
                            src="/images/room/premium-king.jpg"
                            alt="프리미어 킹 룸"
                        >
                    ...
                    <div class="room-card-content">
                        ...
                        <div class="room-card-bottom">
                            ...
                            <a
                                href="/customer/reservation/detail?roomType=PREMIUM_KING"
                                class="btn btn-primary"
                            >
                                상세보기 및 예약
                            </a>
                ...
                <article class="customer-room-card">
                    ...
                    <div class="room-card-content">
                        ...
                        <div class="room-card-bottom">
                            ...
                            <a
                                href="/customer/reservation/detail?roomType=FAMILY"
                                class="btn btn-primary"
                            >
                                상세보기 및 예약
                            </a>
                ...
                <article class="customer-room-card">
                    ...
                    <div class="room-image-wrapper">
                        ...
                        <img
                            src="/images/room/grand-junior-suite.jpg"
                            alt="그랜드 주니어 스위트"
                        >
                    ...
                    <div class="room-card-content">
                        ...
                        <div class="room-card-bottom">
                            ...
                            <a
                                href="/customer/reservation/detail?roomType=JUNIOR_SUITE"
                                class="btn btn-primary"
                            >
                                상세보기 및 예약
                            </a>
                ...
                <article class="customer-room-card sold-out">
                    ...
                    <div class="room-image-wrapper">
                        ...
                        <img
                            src="/images/room/executive-suite.jpg"
                            alt="이그제큐티브 스위트"
                        >
